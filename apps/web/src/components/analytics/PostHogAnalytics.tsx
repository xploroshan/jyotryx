...
// Replay events queued by src/lib/analytics.ts before this lazyOnload script
// ran (the loader's stubs forward them to the real library once it arrives).
if(window.__phq){var q=window.__phq;window.__phq=void 0;for(var i=0;i<q.length;i++){var c=q[i];if(typeof posthog[c[0]]==='function')posthog[c[0]].apply(posthog,c.slice(1));}}`}
    </Script>
  );
}
