  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg border divider bg-white/[0.03] text-xs font-medium text-white/60 hover:text-white/80 transition-colors"
      >
