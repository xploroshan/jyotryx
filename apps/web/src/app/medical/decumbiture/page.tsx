...
import MedicalDecumbitureClient from "./MedicalDecumbitureClient";
...
export const metadata = pageMetadata({ path: "/medical/decumbiture", ...TRADITION_PAGES["/medical/decumbiture"] });

export default function Page() {
  return <MedicalDecumbitureClient />;
}
