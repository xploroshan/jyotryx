          ...
          <form onSubmit={submit} className="space-y-3">
            <div className="grid gap-3 sm:grid-cols-2">
              <label className="block">
                <span className="text-[11px] uppercase tracking-wide text-surface-900/50">
                  {fp.onsetDate}
                </span>
                <input
                  type="date"
        ...
        <div className="space-y-4">
          <div
            className={`rounded-2xl border bg-gradient-to-br ${
              ...
              'from-white/10 to-white/[0.02] border-surface-900/10'
            } p-6`}
          >
            ...
            <p className="text-xs text-surface-900/70 mt-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="glass rounded-2xl p-4">
              ...
              <p className="text-lg font-semibold text-surface-900 mt-1">
          ...
          <div className="glass-strong rounded-2xl p-5">
            ...
            <p className="text-sm text-surface-900/85">{result.guidance}</p>
          </div>
          ...
          {result.symptoms && (
            <div className="glass rounded-2xl p-4 text-xs text-surface-900/60">
              <span className="text-surface-900/40 uppercase tracking-wide">
                {fp.reportedSymptoms}:
              </span>{' '}
              {result.symptoms}
            </div>
