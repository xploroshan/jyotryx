...
export default function HoroscopeClient() {
  ...
  // NOTE: the page H1 (FeatureHeader) is rendered by the SERVER wrapper in
  // page.tsx so it exists in initial HTML for crawlers — do not add a second
  // FeatureHeader here or the page will carry two H1s.
  return (
    <div>
