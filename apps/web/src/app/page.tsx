...
const features = [
  ...
  {
    title: "My Day",
    description: "Personalized daily briefing with planetary hours, profession-specific insights, and do/avoid list.",
    href: "/my-day",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-4.773-4.227-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z" />
  ...
  {
    title: "Numerology",
    description: "Name analysis, brand numerology, and personal year forecasts using Chaldean & Vedic systems.",
    href: "/numerology",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  {
    title: "Tarot Reading",
    description: "Draw tarot cards with Single, Three-Card, and Celtic Cross spreads. AI-powered interpretations with Vedic wisdom.",
    href: "/tarot",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  {
    title: "Vastu Shastra",
    description: "Property analysis with direction-based remedies, room placement guidance, and Vastu score for your space.",
    href: "/vastu",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  {
    title: "KP Astrology",
    description: "Krishnamurti Paddhati system with Placidus cusps, sub-lord analysis, and house significators.",
    href: "/kp-astrology",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "D9 Navamsa, D10 Dashamsha, and other divisional charts for deeper astrological insight.",
    href: "/divisional",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}>
