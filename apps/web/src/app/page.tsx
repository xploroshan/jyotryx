    ...
    <div>
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-5 sm:px-8 text-center fade-in-up">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.05] border border-white/[0.08] text-[13px] text-white/50 mb-8">
      ...
      <section className="py-24 sm:py-32 px-5 sm:px-8">
        <div className="mx-auto max-w-5xl">
          <div className="text-center mb-16">
            <p className="text-[13px] font-medium text-primary-400 uppercase tracking-widest mb-3">
              How it works
            </p>
