...
import HellenisticNatalClient from "./HellenisticNatalClient";
...
export const metadata = pageMetadata({ path: "/hellenistic/natal", ...TRADITION_PAGES["/hellenistic/natal"] });

export default function Page() {
  return <HellenisticNatalClient />;
}
