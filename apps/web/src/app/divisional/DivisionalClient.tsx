  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 fade-in-up">
      ...
      <div className="surface-card p-6 mb-6">
        ...
        {/* Chart Type */}
        <div className="mb-4">
          <label className="text-sm text-secondary mb-2 block">{t.divisional.chartType}</label>
      ...
      {result && (
        <div className="surface-card p-6">
          <h3 className="text-lg font-semibold text-surface-950 mb-4">{result.type} {t.divisional.chartLabel}</h3>
              ...
              <tbody>
                {result.positions.map((p) => (
                  <tr key={p.planet} className="border-b border-[rgba(12,8,5,0.08)] text-emphasis">
                    <td className="py-2 px-3 font-medium text-surface-950">{p.planet}</td>
