      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 py-10 fade-in-up">
        ...
        <nav aria-label="Breadcrumb" className="mb-4 text-xs text-surface-50/40">
          <ol className="flex flex-wrap items-center gap-1.5">
            <li>
              <Link href="/" className="hover:text-surface-50">Home</Link>
            </li>
            <li>›</li>
            <li>
              <Link href="/panchang" className="hover:text-surface-50">Panchang</Link>
            </li>
            <li>›</li>
            <li>
              <Link href="/panchang/cities" className="hover:text-surface-50">Cities</Link>
            </li>
            <li>›</li>
        ...
        <header className="mb-8">
          ...
          <p className="text-sm text-surface-50/50 mt-2">{todayDisplay}</p>
        </header>

        {panchang ? (
          <section className="surface-card p-6 mb-6">
            <h2 className="text-lg font-semibold text-surface-50 mb-4">Today's Panchang</h2>
            ...
            <p className="text-xs text-surface-50/40 mt-4">
          ...
          <section className="surface-card p-6 mb-6 text-sm text-surface-50/50">
        ...
        <article className="surface-card p-6 mb-6 prose-invert prose-sm max-w-none">
          ...
          <h3 className="text-base font-semibold text-surface-50 mt-5 mb-2">
        ...
        <section className="surface-card p-6">
          <h2 className="text-lg font-semibold text-surface-50 mb-3">More for {city.name}</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link
              href={`/kundli/${city.slug}`}
              className="block p-3 rounded-lg bg-white/[0.03] hover:bg-white/[0.06] transition-colors"
            >
              <p className="text-sm font-medium text-surface-50">Free Kundli for {city.name}</p>
              <p className="text-xs text-surface-50/50 mt-1">
            ...
            <Link
              ...
              className="block p-3 rounded-lg bg-white/[0.03] hover:bg-white/[0.06] transition-colors"
            >
              <p className="text-sm font-medium text-surface-50">Find an auspicious muhurat</p>
              <p className="text-xs text-surface-50/50 mt-1">
...
function Row({
  ...
  return (
    <div className="flex items-baseline justify-between gap-3 border-b border-white/[0.04] pb-1.5">
      ...
      <dd className={`text-sm ${tone === 'warning' ? 'text-amber-300' : 'text-surface-50'}`}>{v}</dd>
    </div>
  );
}
