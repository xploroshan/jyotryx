...
import WesternSynastryClient from "./WesternSynastryClient";
...
export const metadata = pageMetadata({ path: "/western/synastry", ...TRADITION_PAGES["/western/synastry"] });

export default function Page() {
  return <WesternSynastryClient />;
}
