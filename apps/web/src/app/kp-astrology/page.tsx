...
import KpAstrologyClient from "./KpAstrologyClient";
...
export const metadata = pageMetadata({ path: "/kp-astrology", ...TRADITION_PAGES["/kp-astrology"] });

export default function Page() {
  return <KpAstrologyClient />;
}
