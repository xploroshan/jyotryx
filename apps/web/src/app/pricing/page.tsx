...
export default function PricingPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-16 fade-in-up">
      ...
      <div className="mt-16">
        <h2 className="text-xl font-semibold text-white text-center mb-2">{t.pricing.creditPacksTitle}</h2>
        <p className="text-xs text-white/40 text-center mb-6">{t.pricing.creditPacksSubtitle}</p>
          ...
          {creditPacks === null
            ...
            : creditPacks.map((pack) => (
                <div key={pack.id} className={`surface-card p-5 relative ${pack.popular ? "border-primary-500/30 ring-1 ring-primary-500/10" : ""}`}>
                  ...
                  <div className="text-xs text-white/50 mb-1">{pack.credits} {t.pricing.credits}</div>
                  <div className="text-2xl font-bold text-white mb-4">{fmt(pack.price)}</div>
                  <button
