  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        ...
        <Stat label="Rejected" value={stats.totalRejected} accent="text-ink-500" />
      ...
      <div className="surface-card p-6">
        <header className="mb-4">
          <h2 className="text-lg font-semibold text-ink-900">Program settings</h2>
        ...
        <div className="space-y-5">
          ...
          <label className="flex items-center justify-between gap-4">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                enabled ? "bg-emerald-500" : "bg-black/15"
              }`}
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-2">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                    bonusDays === d
                      ...
                      : "bg-black/[0.05] hover:bg-black/[0.08] text-ink-700"
                  }`}
                >
                  {d} days
                </button>
              ...
              />
              <span className="text-xs text-ink-500">days (1–365)</span>
            </div>
          </div>
          ...
          <div className="pt-2 flex items-center gap-3">
            ...
            <button
              ...
              disabled={saving}
              className="px-4 py-2 rounded-lg bg-black/[0.05] hover:bg-black/[0.08] text-ink-700 text-sm"
            >
              Reset
            </button>
          </div>
