  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        ...
        <Stat label="Rejected" value={stats.totalRejected} accent="text-white/50" />
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              />
              <span className="text-xs text-white/40">days (1–365)</span>
            </div>
          </div>
          ...
          <div className="pt-2 flex items-center gap-3">
            ...
            <button
              ...
              disabled={saving}
              className="px-4 py-2 rounded-lg bg-white/[0.04] hover:bg-white/[0.08] text-white/70 text-sm"
            >
              Reset
            </button>
          </div>
