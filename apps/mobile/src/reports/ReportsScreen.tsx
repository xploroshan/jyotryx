    ...
    <Screen>
      ...
      {locked ? (
        <Card className="mb-4" testID="reports-locked">
          <Text className="text-fg font-semibold mb-1">Unlock this report</Text>
          <Muted>Reports are a one-time unlock. Purchasing ships with the payments update (P5).</Muted>
        </Card>
      ) : null}
